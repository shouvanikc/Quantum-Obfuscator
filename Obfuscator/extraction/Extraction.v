...
Require Import obfuscator.ListRepresentation.
Require Import obfuscator.RzkGateSet.
Require Import obfuscator.GateCancellation.
Require Import obfuscator.HadamardReduction.
Require Import obfuscator.RotationMerging.
Require Import obfuscator.NotPropagation.
Require Import obfuscator.Optimize.
Require Import obfuscator.ReverseOptimizations.
...
(* From reverse_optimizations.v *)
Extraction Implicit undo_H_equivalence1 [dim].
Extraction Implicit undo_H_equivalence2 [dim].
Extraction Implicit undo_H_equivalence3 [dim].
Extraction Implicit undo_H_equivalence4 [dim].
Extraction Implicit undo_H_equivalence5 [dim].
Extraction H_create_rule.
Extraction add_obfuscated_H.
Extraction X_create_rule.
Extraction add_obfuscated_X.
Extraction Rz_create_rule.
Extraction add_obfuscated_Rz.
Extraction CNOT_create_rule.
Extraction add_obfuscated_CNOT.
Extraction expand_circuit.
Extraction add_comp_circuit_bottom.
Extraction combine_circuits.
Extraction obfuscate.
Extraction obfuscate_secondary.
Extraction add_teleport.
Extraction add_random_circuit.
Extraction teleport_connect.
Extraction teleport_expand.
Extraction expand_teleport_short.
...
Extraction "ExtractedCode.ml" 
  ...
  teleport_expand teleport_connect expand_teleport_short add_random_circuit
  cancel_single_qubit_gates cancel_two_qubit_gates merge_rotations
  hadamard_reduction not_propagation
  optimize obfuscate obfuscate_secondary.
